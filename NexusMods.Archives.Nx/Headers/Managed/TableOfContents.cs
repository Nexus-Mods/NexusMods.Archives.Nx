...
public class TableOfContents : IEquatable<TableOfContents>
{
    ...
    public bool Equals(TableOfContents? other)
    {
        ...
        return BlockCompressions.SequenceEqual(other.BlockCompressions) && Blocks.SequenceEqual(other.Blocks) && Entries.SequenceEqual(other.Entries) && Pool.SequenceEqual(other.Pool) && PoolSize == other.PoolSize;
    }
