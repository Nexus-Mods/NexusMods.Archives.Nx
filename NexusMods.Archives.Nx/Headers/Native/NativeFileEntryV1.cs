...
/// </summary>
/// <remarks>
///     V0 represents <see cref="ArchiveVersion.V1" />.
/// </remarks>
public struct NativeFileEntryV1 : INativeFileEntry, IEquatable<NativeFileEntryV1>
{
    ...
    /// <inheritdoc />
    public bool Equals(NativeFileEntryV1 other) => Hash == other.Hash && DecompressedSize == other.DecompressedSize && _offsetPathIndexTuple.Equals(other._offsetPathIndexTuple);
