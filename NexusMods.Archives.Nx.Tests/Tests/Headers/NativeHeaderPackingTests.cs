...
public class NativeHeaderPackingTests
{
    ...
    [Theory, AutoNativeHeaders]
    public void VersionShouldBe4Bits(NativeFileHeader header)
    {
    ...
    [Theory, AutoNativeHeaders]
    public void BlockSizeShouldBe4Bits(NativeFileHeader header)
    {
        PackingTestHelpers.AssertSizeBits(
            ref header, 
            (ref NativeFileHeader instance, long value) => instance.BlockSize = (byte)value,
    ...
    public void ChunkSizeAndPageCountCanBePacked(NativeFileHeader header)
    {
        ...
        foreach (var currentPageCount in Permutations.GetBitPackingOverlapTestValues(13))
        {
            PackingTestHelpers.TestPackedProperties(
                ...
                (ref NativeFileHeader instance, long value) => instance.TocPageCount = (ushort)value,
                (ref NativeFileHeader instance) => instance.TocPageCount,
                currentChunkSize,
                currentPageCount
            );
        }
    ...
    [Theory, AutoNativeHeaders]
    public void ChunkSizeShouldBe3Bits(NativeFileHeader header)
    {
        PackingTestHelpers.AssertSizeBits(
            ref header, 
            (ref NativeFileHeader instance, long value) => instance.ChunkSize = (byte)value,
    ...
    [Theory, AutoNativeHeaders]
    public void PageCountShouldBe13Bits(NativeFileHeader header)
    {
        PackingTestHelpers.AssertSizeBits(
            ref header, 
            (ref NativeFileHeader instance, long value) => instance.TocPageCount = (ushort)value,
