...
public class TocNumBlocksColumn : IColumn
{
    public const string SizeAfterCompressionFileNameFormat = "num-blocks-{0}.{1}.{2}.{3}.txt";

    public string Id => nameof(TocNumBlocksColumn);

    public string ColumnName => "Num Blocks";

    public string Legend => "Number of Blocks";
